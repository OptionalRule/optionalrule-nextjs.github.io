---
slug: when-failure-isnt-an-option-in-5e
title: When Failure Isn’t an Option in 5e
date: '2021-04-21'
excerpt: >-
  Advice for DMs on embracing failure as a tool in 5e, avoiding stalled plots,
  and using techniques like success-at-cost to keep play dynamic.
featured_image: /images/depressed_thief_480x637.jpg
draft: false
showToc: false
tags:
  - DM Advice
...
Risk is at the heart of adventure and acknowledging **_failure with appropriate consequences in an important dynamic in TTRPGs_**. Additionally, how a character fails can itself be an important element for driving adventures forward. With this in mind, DMs have several tools available to handle failure and keep the game flowing. Among these:
  ...
  * Matt Colville's Running the Game series. In particular <YouTubeEmbed id="l1zaNJrXi5Y" title="Many Fail States" /> discusses different ways to handle failure. Also, some reflection on <YouTubeEmbed id="8Q8bVPpc84A" title="Catastrophic Failure" /> in games acknowledges that sometimes you just have to accept failure.
  * My aforementioned [Progressive Failure and Rising Tension](/2021/01/03/progressive-failures-and-rising-tension-in-5th-edition/) creates an interactive and dynamic system to allow players to **_manage failure through rising stakes and increasing tension_**.

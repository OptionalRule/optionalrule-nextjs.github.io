---
slug: engaging-players-with-magic-item-creation
title: Engaging Players with Magic Item Creation
date: '2021-02-17'
excerpt: >-
  Streamline 5e item crafting with recipe tracking, simple foraging and
  harvesting checks, and CR-themed major ingredients that create proactive
  hooks.
featured_image: /images/steve_stark_480x371.jpeg
draft: false
showToc: false
tags:
  - DnD 5e
...
![A woman forging a sword on a firey anvil.](/images/steve_stark_480x371.jpeg)
...
A guide for how to estimate rarity based on CR is provided in Chapter 2 of Xanathar's Guide to Everything, under [Crafting an Item](https://www.dndbeyond.com/sources/xgte/downtime-revisited#CraftinganItem).
...
Some creatures already provide guidelines for this kind of effect or item creation. For instance, [Ice Trolls](https://forgottenrealms.fandom.com/wiki/Ice_troll) list some effects that can be achieved that are thematically tied to the setting and monster abilities. In a similar way, other creatures or locations may provide similar opportunities for item creation. In effect this just expands the treasure system, while engaging the player with active hooks.

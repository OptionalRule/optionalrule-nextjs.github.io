...
date: "2021-01-08"
excerpt: "Why friendship is so important for TTRPG groups and in 5th edition games."
...
> [#DnD](https://twitter.com/hashtag/DnD?src=hash&ref_src=twsrc%5Etfw) tip: Play groups should work to be friends. Being part of an RPG group makes you are very vulnerable. Doing voices, expressing emotion, or just asking someone to do something cool with you makes you vulnerable.— Optional Rule (@optionalrule) [January 8, 2021](https://twitter.com/optionalrule/status/1347642826612473859?ref_src=twsrc%5Etfw)
...
> [#DnD](https://twitter.com/hashtag/DnD?src=hash&ref_src=twsrc%5Etfw) Tip: Make friends with your DM. DMing is a particularly vulnerable job. Not only do you have all the vulnerability of all the other players, but you represent adversity to the rest of the group. That can be hard. Most poor DM behavior is compensating for that.— Optional Rule (@optionalrule) [January 8, 2021](https://twitter.com/optionalrule/status/1347643094943019010?ref_src=twsrc%5Etfw)

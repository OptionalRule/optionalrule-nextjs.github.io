...
Foraging for herbs has long been a cherished aspect of the Old-School Renaissance (OSR) gaming experience, offering players the chance to interact with their environment in meaningful ways. In the spirit of this tradition, these Herb Foraging rules for <a href="https://www.thearcanelibrary.com/pages/shadowdark" target="_blank">Shadowdark</a> aim to add an option for strategic play and enhance the immersive nature of your campaigns.
...
These tables are also <a href="/assets/downloads/shadowdar_extended_herblist_v1.pdf" target="_blank">available in PDF</a> form for easy reference at your table.

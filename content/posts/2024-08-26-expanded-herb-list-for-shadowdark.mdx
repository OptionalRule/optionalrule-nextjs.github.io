---
slug: expanded-herb-list-for-shadowdark
title: Foraging for Herbs in Shadowdark
date: '2024-08-26'
excerpt: >-
  OSR-inspired herbalism rules add strategic foraging, preservation checks, an
  expanded herb list, Ranger balance notes, and GM tips to your Shadowdark
  games.
featured_image: /images/herbalist_bench_480x240.png
draft: false
showToc: false
tags:
  - Shadowdark
...
**Focused Foraging:** Search for a specific herb in the area. 
...
**General Foraging:** Search an area for any herbs you can find.
...
These tables are also [available in PDF](/assets/downloads/shadowdar_extended_herblist_v1.pdf) form for easy reference at your table.
...
**Ranger's Efficiency**: Rangers can find and consume herbs as a multitask, which is significantly faster than the 1-hour foraging time for other characters.

**Ranger's Expertise**: The Ranger Herb list includes no drawbacks, maintaining their edge in herbalism.

**Expanded Options**: Rangers can use their search ability on any herb of DC 15 or less from the expanded list, and do not suffer the drawbacks listed.

**Time Management**: While other characters spend significant time foraging, Rangers can perform other tasks, maintaining their versatility.

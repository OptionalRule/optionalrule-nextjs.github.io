---
slug: "understanding-die-average-and-hitpoints"
title: "On Die Averages and Hit Points in 5e"
date: "2021-06-22"
excerpt: "A breakdown of how we arrive at die result average numbers, and how that can cause errors in rolling HP and designing monsters."
...
**aside** I generated some of these examples out of a Jupyter Notebook, which you can run online yourself through <a href="https://mybinder.org/v2/gh/Streamweaver/DnDNotebook/0fe60184a44f012f10b67873958e1752bd8f5341?filepath=Stat%20Generation.ipynb" target="_blank">this link</a>.
...
<img src="/images/skillcheck-480x363.jpg" alt="A group of adventurers leaning over a table, seemingly confused by a map they are looking at" width="480" height="363" />
```python
# Quick pandas code

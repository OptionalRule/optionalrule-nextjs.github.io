...
date: '2023-11-04'
excerpt: >-
  A level-5 DnD 5e grief-themed dungeon born from slain innocents, mixing
  environmental hazards and moral trials across five evocative chambers.
...
![A dark cave leading into a shadowy dungeon.](/images/dungon-entrance_480x600.png)
...
1. **Entrance - Mourning**: 
   ...
   * **Enemies** - 5 [Shadows](https://www.dndbeyond.com/monsters/17010-shadow) (Yes, the CR is low but with the environmental effect I think it's fine. Particularly for the first encounter.)
...
3. **Third Chamber - Reflection**: 
   ...
   * **Enemies**: [Water Weird](https://www.dndbeyond.com/monsters/17208-water-weird) (see below)
...
5. **Final Chamber - Heart of Darkness**: 
   ...
   * **Enemies**: Shadow Horror (use the [Oni](https://www.dndbeyond.com/monsters/16971-oni) stat-block), 2 [Shadow Demons](https://www.dndbeyond.com/monsters/17131-shadow-demon).

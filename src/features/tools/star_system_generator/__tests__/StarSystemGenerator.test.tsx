...
describe('StarSystemGenerator', () => {
  it('renders a seeded system profile', async () => {
    ...
    expect(screen.getByText('Stories at Port')).toBeInTheDocument()
    expect(screen.getByText('Rumors')).toBeInTheDocument()
    expect(screen.getByText('Contracts on Offer')).toBeInTheDocument()
    expect(screen.getByText('People You Meet')).toBeInTheDocument()
    expect(screen.getByText('Encounter en Route')).toBeInTheDocument()
    expect(screen.getByText('Mid-Session Twist')).toBeInTheDocument()

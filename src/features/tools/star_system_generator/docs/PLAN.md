...
For the completed post-MVP generation-method repair sequence, see `AUDIT_FIX_PLAN.md`. For the next compatibility-contract remodel after the deep audit, see `POST_AUDIT_REMODEL_PLAN.md`.

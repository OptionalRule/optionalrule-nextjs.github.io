...
| **7** | Add new audit checks. Manual review of 20 sample systems. Tune templates and rules based on review. **Phase 3 carryover:** widen spineSummary length variance (Phase 3 clustered tightly at 111–116 chars). Tune empty-story rate if Phase 4 didn't resolve it. | 0.5 week | New audit passes. Sample review shows cohesion improvement. | ⏳ Not yet planned |
...
**Total: ~8.5 weeks** of focused work. **Completed so far:** Phases 0, 1, 2, 3, 4 (~6 weeks of plan-equivalent effort).

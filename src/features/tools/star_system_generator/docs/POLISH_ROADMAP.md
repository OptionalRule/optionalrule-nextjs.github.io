...
- [Companion systems debris layer](../../../../../docs/superpowers/specs/2026-05-15-companion-systems-design.md) — encroachment fix bundle (1 generator bug, 4 viewer rendering caps, circumbinary keep-out ring sync) plus a ten-archetype debris configuration layer (mass-transfer stream, common-envelope shell, polar ring, Trojan camp, inner-pair halo, Kozai scattered halo, Hill capture cone, exocomet swarm, accretion bridge, Gardener cordon). Each archetype auto-spawns a paired structured phenomenon and can anchor settlements/ruins. Four new audit codes guard the invariants. All 6 phases on `develop`.

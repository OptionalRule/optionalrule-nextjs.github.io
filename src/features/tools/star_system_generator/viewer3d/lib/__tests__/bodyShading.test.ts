...
function fakeBody(category: OrbitingBody['category']['value'], overrides: Partial<OrbitingBody> = {}): OrbitingBody {
  return {
    ...
    detail: {
      ...
      mineralComposition: { value: '', confidence: 'derived' },
      magneticField: { value: '', confidence: 'derived' },
      atmosphericTraces: { value: '', confidence: 'derived' },
      hydrology: { value: '', confidence: 'derived' },
      topography: { value: '', confidence: 'derived' },
      rotationProfile: { value: '', confidence: 'derived' },
      seismicActivity: { value: '', confidence: 'derived' },
      surfaceHazards: { value: '', confidence: 'derived' },
      dayLength: { value: '', confidence: 'derived' },
      surfaceLight: { value: '', confidence: 'derived' },
      axialTilt: { value: '', confidence: 'derived' },
      skyPhenomena: { value: '', confidence: 'derived' },
      atmosphericPressure: { value: '', confidence: 'derived' },
      windRegime: { value: '', confidence: 'derived' },
      tidalRegime: { value: '', confidence: 'derived' },
      acousticEnvironment: { value: '', confidence: 'derived' },
      resourceAccess: { value: '', confidence: 'derived' },
      biosphereDistribution: { value: '', confidence: 'derived' },
    },
    moons: [],
    filterNotes: [],
    traits: [],

...
- `scene/` — react-three-fiber primitives and overlay markers (Star, Body, Orbit, Belt, Ring, Moon, HazardVolume, GuBleedVolume, BodySettlements, MarkerInstances). HUD glyphs live in `scene/overlay/`.
